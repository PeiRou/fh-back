...
function getTotalRecharge() {
    ...
    $.ajax({
        ...
        type:'post',
        dataType:'json',
        data:{rechType:rechType,payOnlineId:payOnlineId,startDate:startDate,endDate:endDate,killTest:killTest,account:account,dateType:dateType},
...
function excelRecharges() {
    ...
    var pay_online_id = $('#pay_online_id').val();
    var account_type = $('#account_type').val();
    var account_param = $('#account_param').val();
    var amount = $('#amount').val();
    var fullName = $('#fullName').val();
    var killTestUser = $('#killTestUser:checked').val();
    var recharges_id = $('#Recharges_id').val();
    var dateType = $('#dateType').val();
