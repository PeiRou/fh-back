    ...
    dataTable = $('#reportGagentTable').DataTable({
        ...
        columns: [
            {data:function(data){              //账号
                    ...
                    return '<a href="/back/control/reportManage/agent?zd='+data.general_id+'&start='+timeStart+'&end='+timeEnd+'">'+data.general_account +'</a>';
                }},
...
function exportUser() {
    jc = $.confirm({
        ...
        closeIcon:true,
        boxWidth:'30%',
        content: 'url:/back/modal/exportReportGAgent',
        buttons: {
            formSubmit: {
                text:'确定提交',
                btnClass: 'btn-blue',
