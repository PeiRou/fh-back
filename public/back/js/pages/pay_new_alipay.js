$(function () {
    ...
    $('#menu-payNewManage-alipay').addClass('active');
    ...
    $('#payAlipayTable').DataTable({
        ...
        serverSide: true,
        ordering: false,
        ajax: '/back/datatables/payAlipayNew',
        columns: [
            {data:'payeeName'},
            {data:'payee'},
            {data:'qrCode'},
...
function add() {
    jc = $.confirm({
        ...
        closeIcon:true,
        boxWidth:'26%',
        content: 'url:/back/modal/addPayAlipayNew',
        buttons: {
            formSubmit: {
                text:'确定提交',
                btnClass: 'btn-blue',
...
function edit(id) {
    jc = $.confirm({
        ...
        closeIcon:true,
        boxWidth:'26%',
        content: 'url:/back/modal/editPayAlipayNew/'+id,
        buttons: {
            formSubmit: {
                text:'确定提交',
                btnClass: 'btn-blue',
