<form id="addPayBankForm" class="ui mini form" action="<?php echo e(url('/action/admin/addPayBank')); ?>">
    <div class="field">
        <label>选择银行</label>
        <div class="ui input icon">
            <select class="ui fluid dropdown" name="paramId">
                ...
                <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($item->bank_id); ?>"><?php echo e($item->name); ?></option>
