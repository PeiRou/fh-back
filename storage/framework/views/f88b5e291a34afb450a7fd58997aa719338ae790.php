<?php $__env->startSection('title','提款记录'); ?>
                ...
                <div class="fields">
                    ...
                    <div class="one wide field">
                        <select class="ui dropdown" id="rechLevel" style='height:32px !important'>
                            ...
                            <?php $__currentLoopData = $rechLevel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
