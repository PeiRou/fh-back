<?php $__env->startSection('title','历史注单搜索'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="table-content">
                ...
                <div class="fields">
                    <div class="one wide field">
                        <select class="ui dropdown" id="game" style='height:32px !important'>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>后is
                        </select>
                    </div>
                    <div class="one wide field">
        ...
        <table id="betHistoryTable" class="ui small table" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th width="200">订单号</th>
                <th>下单时间</th>
