<?php $__env->startSection('title','实时滚单'); ?>
        ...
        <div class="table-quick-bar" style="padding-bottom: 10px;">
            <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="ui checkbox">
                    <input type="checkbox" tabindex="0" value="<?php echo e($item->game_id); ?>" name="gamesData" class="hidden">
                    <label><?php echo e($item->game_name); ?></label>
                </div>
