<?php $__env->startSection('title','系统参数配置'); ?>
        ...
        <table align="center" class="ui celled small table">
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->test_account_money); ?>" data-id-input="test_account_money"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->reg_black_list); ?>" data-id-input="reg_black_list"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->lhc_jin_num); ?>" data-id-input="lhc_jin_num"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->lhc_mu_num); ?>" data-id-input="lhc_mu_num"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->lhc_shui_num); ?>" data-id-input="lhc_shui_num"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->lhc_huo_num); ?>" data-id-input="lhc_huo_num"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->lhc_tu_num); ?>" data-id-input="lhc_tu_num"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->online_service_url); ?>" data-id-input="online_service_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->default_skin); ?>" data-id-input="default_skin"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->index_qq_url); ?>" data-id-input="index_qq_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->index_wechat_url); ?>" data-id-input="index_wechat_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->index_phone_url); ?>" data-id-input="index_phone_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->index_service_qq_url); ?>" data-id-input="index_service_qq_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->index_agent_qq_url); ?>" data-id-input="index_agent_qq_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->index_agent_email_url); ?>" data-id-input="index_agent_email_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->oneday_reg_user_num); ?>" data-id-input="oneday_reg_user_num"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->reg_ip_black_list); ?>" data-id-input="reg_ip_black_list"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->open_site_url); ?>" data-id-input="open_site_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->allow_same_fullname_reg); ?>" data-id-input="allow_same_fullname_reg"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->noallow_bet_8_num); ?>" data-id-input="noallow_bet_8_num"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->drawing_time); ?>" data-id-input="drawing_time"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->web_captcha); ?>" data-id-input="web_captcha"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->kfb_auto_savecode); ?>" data-id-input="kfb_auto_savecode"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->allow_user_register); ?>" data-id-input="allow_user_register"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->activity_money_admin); ?>" data-id-input="activity_money_admin"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->maintain_page); ?>" data-id-input="maintain_page"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->maintain_page_info); ?>" data-id-input="maintain_page_info"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->low_recharge_money); ?>" data-id-input="low_recharge_money"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->drawing_way); ?>" data-id-input="drawing_way"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->app_domain); ?>" data-id-input="app_domain"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->pc_app_download_url); ?>" data-id-input="pc_app_download_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->mobile_app_download_url); ?>" data-id-input="mobile_app_download_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->app_domain_open); ?>" data-id-input="app_domain_open"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->open_login_google_captcha); ?>" data-id-input="open_login_google_captcha"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->user_reg_qq_input); ?>" data-id-input="user_reg_qq_input"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->user_reg_email_input); ?>" data-id-input="user_reg_email_input"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->user_reg_mobile_input); ?>" data-id-input="user_reg_mobile_input"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->agent_vip_domain); ?>" data-id-input="agent_vip_domain"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->drawing_money_limit); ?>" data-id-input="drawing_money_limit"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->user_reg_message_info); ?>" data-id-input="user_reg_message_info"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->game_nobet_time); ?>" data-id-input="game_nobet_time"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->agent_vip_service_url); ?>" data-id-input="agent_vip_service_url"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->native_app_domain); ?>" data-id-input="native_app_domain"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->feidan_before_domain_api); ?>" data-id-input="feidan_before_domain_api"/>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
                        <input type="text" name="" style="width: 700px;height: 28px;" value="<?php echo e($set->feidan_back_domain_api); ?>" data-id-input="feidan_back_domain_api"/>
                    </div>
                </td>
