<form id="addNoticeForm" class="ui mini form" action="<?php echo e(url('/action/admin/addNotice')); ?>">
    <div class="field">
        <label>公告标题</label>
    ...
    <div class="field">
        ...
        <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="ui checkbox">
                <input type="checkbox" tabindex="0" value="<?php echo e($item->value); ?>" name="level_id[]" class="hidden">
