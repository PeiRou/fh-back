...
class Bets extends Model
{
    ...
    public static function AssemblyFundDetails($param){
        $aSql = Bets::select(DB::raw("users.username,bet.user_id,bet.order_id,bet.updated_at,bet.status,bet.bet_money as money,bet.bet_balance as balance,bet.issue,bet.game_id,game.game_name,bet.playcate_name as playcate_name,'' as agent,bet.color as agent_id,bet.bet_info as content,'' as content1,bet.freeze_money,bet.unfreeze_money,bet.nn_view_money,bet.bunko as c_money,bet.bet_id,'' as rechargesType"))
