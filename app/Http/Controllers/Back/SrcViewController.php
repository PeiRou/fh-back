...
//        return view('back.open.bjkl8');
    ...
    public function reportGamesApiInfo_Tc(){
        return view('back.gamesApi.Report.listInfo_Tc');
    }
    public function reportGamesApiUserBet_TC(){
        return view('back.gamesApi.Report.userBet_Tc');
    }
    //会员报表
