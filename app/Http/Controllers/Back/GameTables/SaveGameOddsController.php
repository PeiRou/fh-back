    ...
    function updateBatch($data,$id){
        ...
        if($error == "yes"){
            ...
            if($run == 1){
                ...
                $game = Games::select('game_id as id','game_name as name','mode','code','order as sort','cate','maxReward','status as open','iconUrl','pageUrl','holiday_start as restStartDate','holiday_end as restEndDate','amount','isBan')->get();
