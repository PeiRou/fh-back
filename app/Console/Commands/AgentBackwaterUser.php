...
class AgentBackwaterUser extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'AgentOdds:AgentBackwaterUser {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '代理模式返水会员表生成数据';
    ...
    public function handle()
    {
        ...
        foreach ($aDate as $kDate => $iDate){
            \App\Jobs\AgentBackwaterUser::dispatch($iDate)->onQueue($this->setQueueRealName('zhReportAgentStatementDaily'));
        }
        $this->info('ok');
    }
