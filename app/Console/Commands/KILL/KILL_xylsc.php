...
class KILL_xylsc extends Command
{
    protected $gameId = 905;
    protected $signature = 'KILL_xylsc';
    protected $description = '匈牙利赛车-定时杀率';
    ...
    public function handle()
    {
        ...
        if(isset($get) && $get && !empty($exeBase)){
            ...
            if(isset($get->excel_num) && $get->excel_num == 0){
                ...
                if($update)
                    event(new RunXylsc($opennum,$get->issue,$this->gameId,$get->id,true)); //新--结算
            }
        }
    }
}