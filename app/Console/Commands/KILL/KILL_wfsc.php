...
class KILL_wfsc extends Command
{
    protected $gameId = 914;
    protected $signature = 'KILL_wfsc';
    protected $description = '五分赛车-定时杀率';
    ...
    public function handle()
    {
        ...
        if(isset($get) && $get && !empty($exeBase)){
            ...
            if(isset($get->excel_num) && $get->excel_num == 0){
                ...
                if($update)
                    event(new RunWfsc($opennum,$get->issue,$this->gameId,$get->id,true)); //新--结算
            }
        }
    }
}