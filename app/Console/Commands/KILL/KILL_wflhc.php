...
class KILL_wflhc extends Command
{
    protected $gameId = 916;
    protected $signature = 'KILL_wflhc';
    protected $description = '五分六合彩-定时杀率';
    ...
    public function handle()
    {
        ...
        if(isset($get) && $get && !empty($exeBase)){
            ...
            if(isset($get->excel_num) && $get->excel_num == 0){
                ...
                if($update)
                    event(new RunWflhc($opennum,$get->issue,$this->gameId,$get->id,true)); //新--结算
            }
        }
    }
}