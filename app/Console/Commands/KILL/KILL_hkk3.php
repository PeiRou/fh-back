...
class KILL_hkk3 extends Command
{
    protected $gameId = 920;
    protected $signature = 'KILL_hkk3';
    protected $description = '香港快三-定时杀率';
    ...
    public function handle()
    {
        ...
        if(isset($get) && $get && !empty($exeBase)){
            ...
            if(isset($get->excel_num) && $get->excel_num == 0){
                ...
                if($update)
                    event(new RunHkk3($opennum,$get->issue,$this->gameId,$get->id,true)); //新--结算
            }
        }
    }
}