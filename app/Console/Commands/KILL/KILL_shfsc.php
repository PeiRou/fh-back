...
class KILL_shfsc extends Command
{
    protected $gameId = 917;
    protected $signature = 'KILL_shfsc';
    protected $description = '十分赛车-定时杀率';
    ...
    public function handle()
    {
        ...
        if(isset($get) && $get && !empty($exeBase)){
            ...
            if(isset($get->excel_num) && $get->excel_num == 0){
                ...
                if($update)
                    event(new RunShfsc($opennum,$get->issue,$this->gameId,$get->id,true)); //新--结算
            }
        }
    }
}