...
class KILL_eflhc extends Command
{
    protected $gameId = 913;
    protected $signature = 'KILL_eflhc';
    protected $description = '二分六合彩-定时杀率';
    ...
    public function handle()
    {
        ...
        if(isset($get) && $get && !empty($exeBase)){
            ...
            if(isset($get->excel_num) && $get->excel_num == 0){
                ...
                if($update)
                    event(new RunEflhc($opennum,$get->issue,$this->gameId,$get->id,true)); //新--结算
            }
        }
    }
}