...
class KILL_yflhc extends Command
{
    protected $gameId = 910;
    protected $signature = 'KILL_yflhc';
    protected $description = '一分六合彩-定时杀率';
    ...
    public function handle()
    {
        ...
        if(isset($get) && $get && !empty($exeBase)){
            ...
            if(isset($get->excel_num) && $get->excel_num == 0){
                ...
                if($update)
                    event(new RunYflhc($opennum,$get->issue,$this->gameId,$get->id,true)); //新--结算
            }
        }
    }
}