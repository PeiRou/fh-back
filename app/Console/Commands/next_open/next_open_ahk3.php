...
class next_open_ahk3 extends Command
{
    protected  $code = 'ahk3';
    protected  $gameId = 13;
    protected $signature = 'next_open_ahk3';
    protected $description = '安徽快3-定時開號';
    ...
    public function handle()
    {
        ...
        $redis_next_issue = $redis->get('ahk3:nextIssue');
        //在redis上的差距
        $redis_gapnum = $redis->get('ahk3:gapnum');
        //在現在實際的差距
