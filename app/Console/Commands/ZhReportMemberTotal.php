...
class ZhReportMemberTotal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ZhReportMemberTotal:TotalSettlement {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '综合盘会员报表结算';
    ...
    public function handle()
    {
        ...
        foreach ($aDate as $kDate => $iDate){
            ZhReportMemberStatementDaily::dispatch($iDate)->onQueue($this->setQueueRealName('zhReportMemberStatementDaily'));
        }
        $this->info('ok');
    }
