...
use App\Jobs\BetStatementDaily;
use Illuminate\Console\Command;

class StatementBetTotal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ReportBet:StatementBetTotal {startTime?} {endTime?}';
    ...
    public function handle()
    {
        ...
        foreach ($aDate as $kDate => $iDate){
            BetStatementDaily::dispatch($iDate)->onQueue($this->setQueueRealName('betStatementDaily'));
        }
        $this->info('ok');
    }
