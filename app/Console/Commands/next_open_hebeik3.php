...
class next_open_hebeik3 extends Command
{
    ...
    public function handle()
    {
        ...
        $redis_needopen = $redis->exists('hebeik3:needopen')?$redis->get('hebeik3:needopen'):'';
        ...
        if($needOpenIssue == $redis_issue)
            $url = Config::get('website.guanIssueServerUrl').'hebeik3';
        else
            $url = Config::get('website.guanIssueServerUrl').'hebeik3?issue='.$needOpenIssue;
        try {
