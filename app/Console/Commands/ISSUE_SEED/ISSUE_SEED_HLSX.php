...
class ISSUE_SEED_HLSX extends Command
{
    protected $signature = 'ISSUE_SEED_HLSX';
    protected $description = '欢乐生肖期数生成-59';
    ...
    public function handle()
    {
        ...
        $sql = "INSERT INTO game_hlsx (issue,opentime) VALUES ";
        for($i=1;$i<=9;$i++){
