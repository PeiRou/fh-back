...
class ISSUE_SEED_TWBG28 extends Command
{
    protected $signature = 'ISSUE_SEED_TWBG28';
    protected $description = '台湾宾果28期数生成-203';
    ...
    public function handle()
    {
        ...
        $checkLastIssue = DB::table('game_twbg28')->select(DB::raw('MAX(id) as maxid'),'issue')->where('opentime',date('Y-m-d 23:55:00',strtotime('-1 days')))->first();
        ...
        $sql = "INSERT INTO game_twbg28 (issue,opentime) VALUES ";
        for($i=1;$i<=203;$i++){
