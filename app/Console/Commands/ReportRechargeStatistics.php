...
use App\Jobs\ReportRechargeDaily;
use Illuminate\Console\Command;

class ReportRechargeStatistics extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ReportRecharge:DailyStatistics {startTime?} {endTime?}';
    ...
    public function handle()
    {
        ...
        foreach ($aDate as $kDate => $iDate){
            ReportRechargeDaily::dispatch($iDate)->onQueue($this->setQueueRealName('reportRechargeDaily'));
        }
        $this->info('ok');
    }
