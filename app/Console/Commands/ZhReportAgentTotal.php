...
class ZhReportAgentTotal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ZhReportAgentTotal:TotalSettlement {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '综合盘代理报表结算';
    ...
    public function handle()
    {
        ...
        foreach ($aDate as $kDate => $iDate){
            ZhReportAgentStatementDaily::dispatch($iDate)->onQueue($this->setQueueRealName('zhReportAgentStatementDaily'));
        }
        $this->info('ok');
    }
