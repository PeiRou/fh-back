...
use App\Jobs\GeneralBetStatementDaily;
use Illuminate\Console\Command;

class GeneralStatementBetTotal extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        foreach ($aDate as $kDate => $iDate){
            GeneralBetStatementDaily::dispatch($iDate)->onQueue($this->setQueueRealName('generalBetStatementDaily'));
        }
        $this->info('ok');
    }
