...
class AGRepository extends BaseRepository
{
    ...
    public function getGameType($key = '')
    {
        return [
            ...
            'YFP'=>['name'=>'水果派对','gameCategory'=>'RNG'],
            'YDZ'=>['name'=>'德州牛仔','gameCategory'=>'RNG'],
            'YBIR'=>['name'=>'飞禽走兽','gameCategory'=>'RNG'],
            'YMFD'=>['name'=>'森林舞会多人版','gameCategory'=>'RNG'],
            'YFD'=>['name'=>'森林舞会','gameCategory'=>'RNG'],
            'YBEN'=>['name'=>'奔驰宝马','gameCategory'=>'RNG'],
            'YHR'=>['name'=>'极速赛马','gameCategory'=>'RNG'],
            'YMFR'=>['name'=>'水果拉霸多人版','gameCategory'=>'RNG'],
            'YGS'=>['name'=>'猜猜乐','gameCategory'=>'RNG'],
            'YFR'=>['name'=>'水果拉霸','gameCategory'=>'RNG'],
            'YMBN'=>['name'=>'百人牛牛','gameCategory'=>'RNG'],
            'YGFS'=>['name'=>'多宝水果拉霸','gameCategory'=>'RNG'],
            'YJFS'=>['name'=>'彩金水果拉霸','gameCategory'=>'RNG'],
            'YMBI'=>['name'=>'飞禽走兽多人版','gameCategory'=>'RNG'],
            'YMBA'=>['name'=>'牛牛对战','gameCategory'=>'RNG'],
            'YMBZ'=>['name'=>'奔驰宝马多人版','gameCategory'=>'RNG'],
            'YMAC'=>['name'=>'动物狂欢','gameCategory'=>'RNG'],
            'YMJW'=>['name'=>'西游争霸','gameCategory'=>'RNG'],
            'YMJH'=>['name'=>'翻倍炸金花','gameCategory'=>'RNG'],
            'YMBF'=>['name'=>'刺激战场','gameCategory'=>'RNG'],
            'YMSG'=>['name'=>'斗三公','gameCategory'=>'RNG'],
            'YMJJ'=>['name'=>'红黑梅方','gameCategory'=>'RNG'],
            'YJTW'=>['name'=>'彩金宝藏世界','gameCategory'=>'RNG'],
            'YMD2'=>['name'=>'疯狂德州','gameCategory'=>'RNG'],
            'YJBZ'=>['name'=>'彩金奔驰宝马','gameCategory'=>'RNG'],
            'YMSL'=>['name'=>'海陆争霸','gameCategory'=>'RNG'],
            'YMDD'=>['name'=>'百人推筒子','gameCategory'=>'RNG'],
            'YMKM'=>['name'=>'功夫万条筒','gameCategory'=>'RNG'],
            'YMDL'=>['name'=>'双喜炸金花','gameCategory'=>'RNG'],
            'YMPL'=>['name'=>'凤凰传奇','gameCategory'=>'RNG'],
            'YMBJ'=>['name'=>'全民21点','gameCategory'=>'RNG'],
            'YMLD'=>['name'=>'福星推筒子','gameCategory'=>'RNG'],
            'YMGG'=>['name'=>'YP刮刮卡','gameCategory'=>'RNG'],
            'YMFW'=>['name'=>'财富转盘','gameCategory'=>'RNG'],
        ][$key] ?? [];
    }
