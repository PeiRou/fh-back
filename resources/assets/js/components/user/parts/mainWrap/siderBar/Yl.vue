				...
				<!--<div class="sub-wrap clearfix">-->
					<!--<div class="center-page">-->
						<!--<div class="memberheader">-->
							<!--<div class="useravatar floatleft"><img src="/static/game/images/userlogo.jpg" width="84" height="83" alt=""></div>-->
							<!--<div class="memberinfo floatleft">-->
								<!--<h1 class="floatleft">-->
                    <!--下午好, <span id="userName" class="blue">admin952</span></h1>-->
						...
						<!--<div class="membersubnavi">-->
							<!--<div class="subnavi blue">-->
								<!--<a href="/financial?tabidx=0" class="router-link-exact-active active">充值</a>-->
								<!--<div class="subnaviarrow" style=""></div>-->
							<!--</div>-->
							<!--<div class="subnavi blue">-->
								<!--<a href="/financial?tabidx=1" class="active">提款</a>-->
								<!--<div class="subnaviarrow" style="display: none;"></div>-->
							<!--</div>-->
							<!--<div class="subnavi blue">-->
								<!--<a href="/financial?tabidx=2" class="active">充值记录</a>-->
								<!--<div class="subnaviarrow" style="display: none;"></div>-->
							<!--</div>-->
							<!--<div class="subnavi blue">-->
								<!--<a href="/financial?tabidx=3" class="active">提款记录</a>-->
								<!--<div class="subnaviarrow" style="display: none;"></div>-->
							<!--</div>-->
							<!--<div class="subnavi blue">-->
								<!--<a href="/financial?tabidx=4" class="active">其它记录</a>-->
								<!--<div class="subnaviarrow" style="display: none;"></div>-->
							<!--</div>-->
						<!--</div>-->
						<!--<div>-->
							<!--<div class="steps">-->
								...
								<!--<div class="tabs">-->
									...
									<!--<router-link to="/frame/yl"class="tab tabactive">银联快捷(扫码)</router-link>-->
								<!--</div>-->
							<!--</div>-->
							<!--<div class="subcontent" style="display: block;">-->
								<!--<div class="subrow">-->
									<!--<div class="subcol1"></div>-->
									<!--<div class="subcol2"><img src="/static/images/bank/method2.jpg" width="533" height="114" alt=""></div>-->
								<!--</div>-->
								<!--<form method="post" target="_blank" action="/userrech/onlinePay.do"><input type="hidden" name="x-session-token" value="R7ZM6nFXUfGJFi9NBYMgMUg7TPi3hHAsR8PyThXy2EOO4BpTIM5qFQ==">-->
									<!--<div class="subrow">-->
										<!--<div class="subcol1">充值金额：</div>-->
										<!--<div class="subcol2"><input name="amount" autocomplete="off" type="number" class="textfield1"> <span class="validation"><img src="/static/images/iconwarning.jpg" width="17" height="15" alt=""> <span class="smalltxt red">支付限额最低100元最高5000元。支付成功自动到账，无需提交存款信息</span></span>-->
										<!--</div>-->
									<!--</div>-->
									<!--<div class="subrow"><input type="hidden" name="rechId" value="227">-->
										<!--<div class="subcol1">支付帐户：</div>-->
										<!--<div class="subcol2"><label title="高通银联" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value=""> <i class="ico-yl"></i><span style="padding-right: 8px;">银联扫码1</span></label></div>-->
									<!--</div>-->
									<!--<div class="subrow remark-subrow">-->
										<!--<div class="subcol1"></div>-->
										<!--<div class="subcol2 blue"><span>温馨提示：</span> <span class="remark-text">单笔100-5000</span></div>-->
									<!--</div>-->
									<!--<div class="subrow margintop30">-->
										<!--<div class="subcol1"></div>-->
										<!--<div class="subcol2"><input type="submit" value="开始充值" class="c-button"></div>-->
									<!--</div>-->
								<!--</form>-->
...
.center-page .ico-yl {
    background: url(/static/images/bank/unionpay_ico.png) no-repeat;
    width: 27px;
    height: 25px;
