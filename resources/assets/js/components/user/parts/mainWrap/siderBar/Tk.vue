                    ...
                    {{NowTime}}, <span id="userName" class="blue">{{userName}}</span></h1>
						...
						<div>
							<div class="stepswithdraw">
								<div class="substeps">
									<div class="substepitmgray1 substepitmblue1"><b>01</b> 提交
									</div>
									<div class="substepitmgray2"><b>02</b> 审核
									</div>
									<div class="substepitmgray2"><b>03</b> 出款
									</div>
									<div class="substepitmgray2"><b>04</b> 到账
									</div>
								</div>
								<div class="line2"></div>
							</div>
									...
									<div>
										<div>
											...
											<div class="margintop40 aligncenter">
												<router-link to="/frame/tjyhk"><img src="/static/images/bank/addbankcard.jpg" width="214" height="112"></router-link>
												</div>
										</div>
									</div>
								</div>
