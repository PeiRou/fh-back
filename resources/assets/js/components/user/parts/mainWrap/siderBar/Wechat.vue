			...
			<div class="content">
				<div class="sub-wrap clearfix">
                    ...
                    {{NowTime}}, <span id="userName" class="blue">{{userName}}</span></h1>
								...
								<p>最后登录：<span id="loginTime">2018-03-08 19:21:42</span></p>
							</div>
						</div>
						...
						<div>
							<div class="steps">
								...
								<div class="tabs">
									...
									<!--<router-link to="/frame/wechat" class="tab tabactive">微信在线支付</router-link>-->
							...
							<div class="subcontent" style="display: block;">
								<div class="subrow">
									...
									<div class="subcol2"><img src="/static/images/bank/method_wx.jpg" width="533" height="114" alt=""></div>
								</div>
								<form>
									<div class="subrow">
										<div class="subcol1">充值金额：</div>
										<div class="subcol2"><input name="amount" autocomplete="off" type="number" class="textfield1" v-model="CzMoney"> <span class="validation"><img src="/static/images/iconwarning.jpg" width="17" height="15" alt=""> <span class="smalltxt red">支付限额最低100元最高999元，
                                    如无法支付请降低额度。支付成功自动到账，无需提交存款信息</span></span>
										</div>
									</div>
									<div class="subrow"><input type="hidden" name="rechId" value="82">
										<div class="subcol1">支付帐户：</div>
										<div class="subcol2"><label title="仁信微信" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value="WX1" v-model="account" > <i class="ico-weixin"></i><span style="padding-right: 8px;">微信1</span></label><label title="淘彩仁信微信" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" v-model="account" value="WX2"> <i class="ico-weixin"></i><span style="padding-right: 8px;">微信2</span></label><label title="星普微信" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value="WX3"> <i class="ico-weixin"></i><span style="padding-right: 8px;">微信3</span></label><label title="新E付微信" class="banklist marginbtm10"><input type="radio" name="payId" v-model="account" class="bankradiobtn" value="WX4"> <i class="ico-weixin"></i><span style="padding-right: 8px;">微信4</span></label></div>
									</div>
									<div class="subrow remark-subrow">
										<div class="subcol1"></div>
										<div class="subcol2 blue"><span>温馨提示：</span> <span class="remark-text">微信扫码100-999恢复交易 由于交易流程更改 如下，1、扫码之前登陆微信，打开收付款，2、点击查看付款码数字，并记下数字。3、打开仁信微信扫码，扫码后出跳出支付页面，输入数字确认即可，（注意：记下付码数字后必需在一分钟内支付，否则会支付无效，要重新生成付款码)</span></div>
									</div>
									<div class="subrow margintop30">
										<div class="subcol1"></div>
										<div class="subcol2"><input type="button" @click="CzBtn" value="开始充值" class="c-button"></div>
									</div>
								</form>
...
export default {
  ...
  computed: {
	...
	methods: {
    CzBtn() {
      if (this.CzMoney < 100 || this.CzMoney > 999) {
        this.$confirm("在线支付充值金额范围: 100 ~ 999", {
...
.center-page .ico-weixin {
  background: url(/static/images/bank/WEIXIN_s.jpg) no-repeat;
  width: 27px;
  height: 25px;
