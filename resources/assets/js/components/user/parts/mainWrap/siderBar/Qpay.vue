						...
						<div>
							<div class="steps">
								...
								<div class="tabs">
									...
									<!--<router-link to="/frame/qpay" class="tab tabactive">QQ在线支付</router-link>-->
							...
							<div class="subcontent" style="display: block;">
								<div class="subrow">
									...
									<div class="subcol2"><img src="/static/images/bank/method_qq.jpg" width="533" height="114" alt=""></div>
								</div>
								<form>
									<div class="subrow">
										<div class="subcol1">充值金额：</div>
										<div class="subcol2"><input name="amount" v-model="CzMoney" autocomplete="off" type="number" class="textfield1"> <span class="validation"><img src="/static/images/iconwarning.jpg" width="17" height="15" alt=""> <span class="smalltxt red">支付限额最低10元最高5000元。支付成功自动到账，无需提交存款信息</span></span>
										</div>
									</div>
									<div class="subrow"><input type="hidden" name="rechId" value="145">
										<div class="subcol1">支付帐户：</div>
										<div class="subcol2"><label title="仁信QQ" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value="Q1" v-model="account"> <i class="ico-qq"></i><span style="padding-right: 8px;">QQ1</span></label><label title="淘彩仁信QQ" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value="Q2" v-model="account"> <i class="ico-qq"></i><span style="padding-right: 8px;">QQ2</span></label><label title="高通QQ钱包" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value="Q3" v-model="account"> <i class="ico-qq"></i><span style="padding-right: 8px;">QQ3</span></label><label title="新码QQ" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value="Q4" v-model="account"> <i class="ico-qq"></i><span style="padding-right: 8px;">QQ4</span></label><label title="新E付QQ" class="banklist marginbtm10"><input type="radio" name="payId" class="bankradiobtn" value="Q5" v-model="account"> <i class="ico-qq"></i><span style="padding-right: 8px;">QQ5</span></label></div>
									</div>
									<div class="subrow remark-subrow">
										<div class="subcol1"></div>
										<div class="subcol2 blue"><span>温馨提示：</span> <span class="remark-text">单笔5000</span></div>
									</div>
  ...
  computed: {
    ...mapGetters({
      ...
      money: "getMoney"
		...
		methods: {
    CzBtn() {
      if (this.CzMoney < 10 || this.CzMoney > 5000) {
        this.$confirm("在线支付充值金额范围: 10 ~ 5000", {
...
.center-page .ico-qq {
    background: url(/static/images/bank/QQ_s.jpg) no-repeat;
    width: 27px;
    height: 25px;
