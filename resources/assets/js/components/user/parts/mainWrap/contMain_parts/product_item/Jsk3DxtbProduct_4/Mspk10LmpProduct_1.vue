<template>
    <table class="u-table2 mt5">
        ...
        <!--<Mspk10LmpProduct_1_title_wtqt></Mspk10LmpProduct_1_title_wtqt>-->
        ...
        <Mspk10LmpProduct_1_content_wt v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId" :info="item" :key="item.id"></Mspk10LmpProduct_1_content_wt>
        <!--<Mspk10LmpProduct_1_content_qt></Mspk10LmpProduct_1_content_qt>-->
...
<script>
    ...
    import Mspk10LmpProduct_1_title_wtqt from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_title_wtqt'
    import Mspk10LmpProduct_1_content from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content'
    import Mspk10LmpProduct_1_content_wt from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content_wt'
    import Mspk10LmpProduct_1_content_qt from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content_qt'
    ...
    export default {
        ...
        components: {
            ...
            Mspk10LmpProduct_1_title_wtqt,
            Mspk10LmpProduct_1_content_wt,
            Mspk10LmpProduct_1_content_qt
        },
