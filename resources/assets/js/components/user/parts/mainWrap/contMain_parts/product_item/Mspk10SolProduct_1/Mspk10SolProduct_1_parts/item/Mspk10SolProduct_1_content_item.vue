<template>
    ...
    <tr>
        <!--{{ item.playCateId }}-->
        <td :data-id="info.id" class="name" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)"><span class="ball" :class="this.ballClass"></span></td>
        <td :data-id="info.id" class="odds" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)">
            <span class="c-txt3">{{ mspk10LmpSealIsTrue ? '--' : info.odds}}</span>
        </td>
        <td :data-id="info.id" class="amount" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}"  @click="!mspk10LmpSealIsTrue && addToCart2(info.id)">
            <input type="text" ref="inp" v-model="mspk10LmpSealIsTrue ? sealInput : betAmountItem2" :disabled="mspk10LmpSealIsTrue">
            <!--{{ betAmountItem2 }}-->
        </td>
    </tr>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ballClass: function () {
                let ballClassName = "c-n" + this.info.name
