    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                ...
                <!--</div>-->
                <div class="fl"><span id="page_game_name">新疆时时彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           MssscZhProduct_1: 'getXjsscZh_Product_1',
                           MssscZhProduct_2: 'getXjsscZh_Product_2',
                           MssscZhProduct_3: 'getXjsscZh_Product_3',
                           // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getXjsscZhProduct_1')
            this.$store.dispatch('getXjsscZhProduct_2')
            this.$store.dispatch('getXjsscZhProduct_3')
