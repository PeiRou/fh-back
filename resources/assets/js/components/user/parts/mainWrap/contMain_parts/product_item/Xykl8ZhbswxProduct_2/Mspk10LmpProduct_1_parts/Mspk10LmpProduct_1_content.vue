<template>
  <tr style="float:left; width: 164.81px">
        <!--<div>你好</div>-->
        <!--{{this.cartList}}-->
        <!--{{ this.info.id }}-->
        <!--{{ this.info.selected }}-->
        ...
        <td :data-id="info.id" class="name" style="width: 57px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)">{{info.name}}</td>
        <td :data-id="info.id" class="amount" style="width: 50px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)">
