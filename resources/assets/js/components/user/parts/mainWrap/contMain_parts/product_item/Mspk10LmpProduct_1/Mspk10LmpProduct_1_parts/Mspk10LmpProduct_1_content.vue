<template>
    <tr style="float:left; width: 25%">
        ...
        <!--<td :data-id="info.id" class="name" @mouseover="addHover" @mouseleave="removeHover" :class="{'hover': hoverActive}" style="width: 69px;"  @click="addToCart(info.id)">{{info.name}} </td>-->
        <!--<td :data-id="info.id" @mouseover="addHover" @mouseleave="removeHover" class="odds" style="width: 58px;" :class="{'hover': hoverActive}" @click="addToCart(info.id)">-->
            <!--<span class="c-txt3">{{info.odds}}</span>-->
        <!--</td>-->
        <!--<td :data-id="info.id" @mouseover="addHover" @mouseleave="removeHover" class="amount" style="width: 80px;" :class="{'hover': hoverActive}" @click="addToCart2(info.id)">-->
            <!--<input type="text" ref="inp" v-model="betAmountItem1">-->
            <!--&lt;!&ndash;{{betAmountItem1}}&ndash;&gt;-->
        <!--</td>-->

        <td :data-id="info.id" class="name" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" style="width: 69px;"  @click="!mspk10LmpSealIsTrue && addToCart(info.id)">{{info.name}}</td>
        <td :data-id="info.id" @mouseover="addHover" @mouseleave="removeHover" class="odds" style="width: 58px;"  :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)">
            <span class="c-txt3">{{ mspk10LmpSealIsTrue ? '--' : info.odds}}</span>
        </td>
        <td :data-id="info.id" @mouseover="addHover" @mouseleave="removeHover" class="amount" style="width: 80px;" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart2(info.id)">
