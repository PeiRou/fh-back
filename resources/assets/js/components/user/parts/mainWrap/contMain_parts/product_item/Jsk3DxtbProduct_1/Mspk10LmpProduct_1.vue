<template>
    <table class="u-table2">
        <!--这里涉及到的数组的重组全部用手动的形式完成-->

        <Mspk10LmpProduct_1_title_sjdx></Mspk10LmpProduct_1_title_sjdx>
        ...
        <!--通过 item.id < 105604 取出前面3个-->

        <Mspk10LmpProduct_1_content_sj v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && item.id < 105604" :info="item" :key="item.id"></Mspk10LmpProduct_1_content_sj>

        <Mspk10LmpProduct_1_content_dx_da></Mspk10LmpProduct_1_content_dx_da>

        <Mspk10LmpProduct_1_content_sj v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && item.id > 105603" :info="item" :key="item.id"></Mspk10LmpProduct_1_content_sj>

        <Mspk10LmpProduct_1_content_dx_xiao></Mspk10LmpProduct_1_content_dx_xiao>

        <!--<Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>-->

        <!--<Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.code != 'DD' && item.code != 'DS' && item.code != 'XD' && item.code != 'XS'" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>-->
...
<script>
    ...
    import Mspk10LmpProduct_1_title_sjdx from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_title_sjdx'
    import Mspk10LmpProduct_1_content from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content'
    import Mspk10LmpProduct_1_content_sj from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content_sj'
    import Mspk10LmpProduct_1_content_dx_da from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content_dx_da'
    import Mspk10LmpProduct_1_content_dx_xiao from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content_dx_xiao'
    ...
    export default {
        ...
        components: {
            ...
            Mspk10LmpProduct_1_title_sjdx,
            Mspk10LmpProduct_1_content,
            Mspk10LmpProduct_1_content_sj,
            Mspk10LmpProduct_1_content_dx_da,
            Mspk10LmpProduct_1_content_dx_xiao
        },
