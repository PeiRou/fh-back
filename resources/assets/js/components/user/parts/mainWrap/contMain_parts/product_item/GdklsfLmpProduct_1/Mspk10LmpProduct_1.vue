<template>
    <table class="u-table2">
            <!--{{info.productInfo.productTitle}}-->

            <Mspk10LmpProduct_1_title v-for="item in info.productInfo.productTitle" v-if="item.id === info.productId.playCateId && isNaN(parseInt(item.code))" :info="item" :key="item.id"></Mspk10LmpProduct_1_title>
            <!--<th colspan="3" v-for="item in Mspk10LmpName" v-if="item.id===140 && isNaN(parseInt(item.code))">{{item.name}}</th>-->
        <!--竖向排列的时候可以取单双,或者筛选的时候,用整除的方式(一列多少,就取整)-->

        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id === 607401" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id === 607403" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id === 607405" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id === 607402" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id === 607404" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id === 607406" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
