        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <!--<div class="fl"><span id="page_game_name">秒速赛车</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span-->
                        <!--id="page_name">两面盘</span> <span id="total_sum_money_text">-->
                                <!--&nbsp;&nbsp;-->
                                <!--当前彩种输赢：<span id="total_sum_money">0.000</span></span>-->
                <!--</div>-->
                <div class="fl"><span id="page_game_name">秒速时时彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
                        id="page_name">整合</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
            ...
            <div>
                ...
                <MssscCombProduct :info="{ productTitle: Mspk10LmpName, productContent: Mspk10LmpInput, product_1: MssscZhProduct_1, product_2_1: MssscZhProduct_2, product_2_2: MssscZhProduct_3}"></MssscCombProduct>
                <!--<MssscCombProduct></MssscCombProduct>-->
...
<script>
    // 引入商品　投注页面
    import MssscCombProduct from './product_item/MssscCombProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           MssscZhProduct_1: 'getMssscZh_product_1',
                           MssscZhProduct_2: 'getMssscZh_product_2',
                           MssscZhProduct_3: 'getMssscZh_product_3',
                           // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getMssscZhProduct_1')
            this.$store.dispatch('getMssscZhProduct_2')
            this.$store.dispatch('getMssscZhProduct_3')
        ...
        methods: {
            ...
            getData () {
                ...
                window.axios.get("/api/getMsssc").then(function (response) {
                    ...
                    // console.log(typeof _data.servertime)
                    // console.log(typeof _data.opentimestamp)
