<template>
    <tr style="float:left; width: 276px;">
        <!--{{info.id}}-->
        <!--<div>你好</div>-->
        <!--{{this.cartList}}-->
        <!--{{ this.info.id }}-->
...
<!--{{info}}-->
        ...
        <!--{{this.ballClass2}}-->
        <!--{{this.ballClass3}}-->
        <td :data-id="info.id" class="name" style="width: 93px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)"><div class="K3Term ball-container2"><b :class="this.ballClass1"></b><b :class="this.ballClass2"></b></div></td>
        ...
        <td :data-id="info.id" class="amount" style="width: 101px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart2(info.id)">
            <input type="text" ref="inp" v-model="betAmountItem1" :disabled="mspk10LmpSealIsTrue">
          <!--{{betAmountItem1}}-->
        </td>
    </tr>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ballClass1: function () {
                let ballClassName = "b" + this.info.name.slice(0,1)
                return ballClassName
            },
            ballClass2: function () {
                let ballClassName = "b" + this.info.name.slice(2,3)
                return ballClassName
            },
            ballClass3: function () {
                let ballClassName = "b" + this.info.name.slice(4,5)
                return ballClassName
            },
