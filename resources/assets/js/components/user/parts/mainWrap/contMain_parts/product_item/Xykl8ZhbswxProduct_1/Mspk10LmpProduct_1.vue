<template>
    <table class="u-table2">
        ...
        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id < 8319506" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
        <tr></tr>

        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id > 8319505" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
