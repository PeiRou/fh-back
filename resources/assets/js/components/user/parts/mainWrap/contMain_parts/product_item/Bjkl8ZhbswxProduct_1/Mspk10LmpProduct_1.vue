<template>
    <table class="u-table2">
        ...
        <Mspk10LmpProduct_1_content v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id < 652106" :info="item" :key="item.id"></Mspk10LmpProduct_1_content>
        <tr></tr>
