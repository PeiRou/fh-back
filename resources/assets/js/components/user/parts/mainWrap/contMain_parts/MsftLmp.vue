    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <div class="fl"><span id="page_game_name">秒速飞艇</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           Mspk10LmpProduct_1: 'getJsftLmpProduct_1',
                           Mspk10LmpProduct_2_1: 'getJsftLmpProduct_2_1',
                           Mspk10LmpProduct_2_2: 'getJsftLmpProduct_2_2',
                           // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getJsftLmpProduct_1')
            this.$store.dispatch('getJsftLmpProduct_2_1')
            this.$store.dispatch('getJsftLmpProduct_2_2')
