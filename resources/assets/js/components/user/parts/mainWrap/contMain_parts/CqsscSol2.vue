        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                ...
                <div class="fl"><span id="page_game_name">重庆时时彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
                        id="page_name">第二球</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
            ...
            <div>
                ...
                <MssscSolProduct2 :info="{ productTitle: Mspk10LmpName, productContent: Mspk10LmpInput, product_1: MssscZhProduct_1, product_2_1: MssscZhProduct_2, product_2_2: MssscZhProduct_3}"></MssscSolProduct2>
...
<script>
    // 引入商品　投注页面
    import MssscSolProduct2 from './product_item/MssscSolProduct2'
