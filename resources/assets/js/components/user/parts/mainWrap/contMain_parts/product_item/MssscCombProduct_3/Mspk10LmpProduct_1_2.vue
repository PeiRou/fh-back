<template>
    <table class="u-table2">
        ...
        <!--0号-->
        <Mspk10LmpProduct_1_content_2 v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && item.code === '0'" :info="item" :key="item.id"></Mspk10LmpProduct_1_content_2>

        <!--1-9号-->
        <Mspk10LmpProduct_1_content_2 v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && parseInt(item.code)" :info="item" :key="item.id"></Mspk10LmpProduct_1_content_2>

        <!--字-->
        <!--没有外面的那个圈-->
        <Mspk10LmpProduct_1_content_2_2 v-for="item in info.productInfo.productContent" v-if="item.playCateId === info.productId.playCateId && isNaN(parseInt(item.code))" :info="item" :key="item.id"></Mspk10LmpProduct_1_content_2_2>
...
<script>
    ...
    import Mspk10LmpProduct_1_content_2 from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content_2'
    import Mspk10LmpProduct_1_content_2_2 from './Mspk10LmpProduct_1_parts/Mspk10LmpProduct_1_content_2_2'
    ...
    export default {
        ...
        components: {
            ...
            Mspk10LmpProduct_1_content_2,
            Mspk10LmpProduct_1_content_2_2
        },
