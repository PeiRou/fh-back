<template>
    <tr style="float:left; width: 165.6px">
        ...
        <td :data-id="info.id" class="name" style="width: 56px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}"  @click="!mspk10LmpSealIsTrue && addToCart(info.id)"><span class="ball c-b1">{{info.name}}</span></td>
        <td :data-id="info.id" class="amount" style="width: 45px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}"  @click="!mspk10LmpSealIsTrue && addToCart(info.id)">
            <span class="c-txt3">{{ mspk10LmpSealIsTrue ? '--' : info.odds}}</span>
        </td>
        <td :data-id="info.id" class="amount" style="width: 60px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}"  @click="!mspk10LmpSealIsTrue && addToCart2(info.id)">
