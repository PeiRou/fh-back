        ...
        <table class="u-table2">
            <!--<div v-for="item in info.productTitle"-->
                ...
                <Mspk10LmpProduct_2_title v-for="item in info.productInfo.productTitle"
                                          v-if="item.id === info.productId.playCateId && isNaN(parseInt(item.code)) && item.id > 78"
                                          :info="item"
...
<!--{{info.productId}}-->
                <!--{{ info.productId }}-->
                <Mspk10LmpProduct_2_content_2 v-for="(item, index) in info.productId" :info="{ productId: item, productInfo: info.productInfo }" :key="index"></Mspk10LmpProduct_2_content_2>
...
<script>
    ...
    import Mspk10LmpProduct_2_content_2 from './Mspk10LmpProduct_2_parts/Mspk10LmpProduct_2_content_2'
