...
<script>
    // 引入商品　投注页面
    import Mspk10LmpProduct from './product_item/GdklsfLmpProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           Mspk10LmpProduct_1: 'getGdklsfLmp_Product_1',
                           Mspk10LmpProduct_2_1: 'getGdklsfLmp_Product_2',
                           Mspk10LmpProduct_2_2: 'getGdklsfLmp_Product_3',
                           // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getGdklsfLmpProduct_1')
            this.$store.dispatch('getGdklsfLmpProduct_2')
            this.$store.dispatch('getGdklsfLmpProduct_3')
