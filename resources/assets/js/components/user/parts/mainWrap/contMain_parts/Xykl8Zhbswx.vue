        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <div class="fl"><span id="page_game_name">幸运快乐8</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
                        id="page_name">总和、比数、五行</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
...
<script>
    // 引入商品　投注页面
    import Mspk10LmpProduct from './product_item/Xykl8ZhbswxProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           Mspk10LmpProduct_1: 'getXykl8Lmp_Product_2',
                           Mspk10LmpProduct_2_1: 'getXykl8Lmp_Product_3',
                           Mspk10LmpProduct_2_2: 'getXykl8Lmp_Product_4',
                           // myState: 'getMyState',
