    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <div class="fl"><span id="page_game_name">北京赛车</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
            ...
            <div>
                <div class="cont-col3-hd clearfix">
                    ...
                    <!--{{this.myState}}-->
                    <!--</div>-->
                    <div class="cont-col3-box2"><span> 金额 </span> <input type="number" class="bet-money"
                                                                         v-model="BET_AMOUNT">
                        <!--{{this.myState}}-->
                ...
                <Mspk10LmpProduct
                        :info="{ productTitle: Mspk10LmpName, productContent: Mspk10LmpInput, product_1: Mspk10LmpProduct_1, product_2_1: Mspk10LmpProduct_2_1, product_2_2: Mspk10LmpProduct_2_2}"></Mspk10LmpProduct>
...
<script>
    // 引入商品　投注页面
    import Mspk10LmpProduct from './product_item/Mspk10LmpProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                ...
                Mspk10LmpProduct_1: 'getPk10LmpProduct_1',
                Mspk10LmpProduct_2_1: 'getPk10LmpProduct_2_1',
                Mspk10LmpProduct_2_2: 'getPk10LmpProduct_2_2',
                // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getPk10LmpProduct_1')
            this.$store.dispatch('getPk10LmpProduct_2_1')
            this.$store.dispatch('getPk10LmpProduct_2_2')
            ...
            getData: function () {
                ...
                window.axios.get("/api/getBjpk10").then(function (response) {
                    ...
                    var djs = parseInt(
                        ...
                        300 - (_data.servertime - _data.opentimestamp)
                    )
                    // 将数据存入vuex
                ...
                // 将所有状态变为初始状态
                this.$store.dispatch('setPk10LmpSealIsTrueToFalse')
            },
            // 如果购物车为空,不能下注
