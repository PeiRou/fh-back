    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <div class="fl"><span id="page_game_name">北京快乐8</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
                        id="page_name">正码</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
...
<script>
    ...
    import Mspk10LmpProduct from './product_item/Xykl8ZmProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           Mspk10LmpProduct_2_2: 'getBjkl8Lmp_Product_5',
                           // myState: 'getMyState',
