    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <div class="fl"><span id="page_game_name">幸运快乐8</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
            ...
            <div>
              ...
              <!--数据尽量不要在父子组件之间传递，在最开始的时候传入vuex state，然后需要循环的时候，组合好然后直接取出。这些数据都可以全局性地使用，之后也好维护。整个项目的数据都可以很快地找到，然后全局性地使用或者传到后台。-->
              ...
              <Xykl8LmpProduct></Xykl8LmpProduct>
...
<script>
    // 引入商品　投注页面
    import Xykl8LmpProduct from './product_item/Xykl8LmpProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           // Mspk10LmpProduct_1: 'getXykl8Lmp_Product_1',
                           // Mspk10LmpProduct_2_1: 'getXykl8Lmp_Product_2',
                           // Mspk10LmpProduct_2_2: 'getXykl8Lmp_Product_3',
                           // Mspk10LmpProduct_3: 'getXykl8Lmp_Product_4',
        ...
        created() {
            ...
            this.$store.dispatch('getXykl8LmpProduct_1')
            this.$store.dispatch('getXykl8LmpProduct_2')
            this.$store.dispatch('getXykl8LmpProduct_3')
            this.$store.dispatch('getXykl8LmpProduct_4')
