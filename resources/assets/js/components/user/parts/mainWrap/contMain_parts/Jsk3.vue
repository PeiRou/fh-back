    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            ...
            <div>
                ...
                <!--江苏骰宝的数据重组，这里我们就不用js进行处理了，之后，全部从后台来的时候，需要处理好的，这通过枚举的方式，把商品及相关的信息展示出来-->

                <Mspk10LmpProduct :info="{ productTitle: Mspk10LmpName, productContent: Mspk10LmpInput, product_1: Mspk10LmpProduct_1, product_2_1: Mspk10LmpProduct_2_1, product_2_2: Mspk10LmpProduct_2_2, product_2_3: Mspk10LmpProduct_2_3, product_2_4: Mspk10LmpProduct_2_4, product_2_5: Mspk10LmpProduct_2_5, product_2_6: Mspk10LmpProduct_2_6}"></Mspk10LmpProduct>
...
<script>
    ...
    import Mspk10LmpProduct from './product_item/Jsk3DxtbProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           Mspk10LmpProduct_1: 'getJsk3Dxtb_Product_1',
                           Mspk10LmpProduct_2_1: 'getJsk3Dxtb_Product_2',
                           Mspk10LmpProduct_2_2: 'getJsk3Dxtb_Product_3',
                           Mspk10LmpProduct_2_3: 'getJsk3Dxtb_Product_4',
                           Mspk10LmpProduct_2_4: 'getJsk3Dxtb_Product_5',
                           Mspk10LmpProduct_2_5: 'getJsk3Dxtb_Product_6',
                           Mspk10LmpProduct_2_6: 'getJsk3Dxtb_Product_7',
        ...
        created() {
            ...
            this.$store.dispatch('getJsk3DxtbProduct_1')
            this.$store.dispatch('getJsk3DxtbProduct_2')
            this.$store.dispatch('getJsk3DxtbProduct_3')
            this.$store.dispatch('getJsk3DxtbProduct_4')
            this.$store.dispatch('getJsk3DxtbProduct_5')
            this.$store.dispatch('getJsk3DxtbProduct_6')
            this.$store.dispatch('getJsk3DxtbProduct_7')
