<template>
    <tr>
        <!--{{ item.playCateId }}-->
        <td :data-id="info.id" class="name" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)"><span class="ball c-b1">{{info.name}}</span></td>
