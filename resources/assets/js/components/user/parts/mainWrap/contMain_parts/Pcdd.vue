    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <div class="fl"><span id="page_game_name">PC蛋蛋</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
                        id="page_name">PC蛋蛋</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           Mspk10LmpProduct_1: 'getPcddPcdd_Product_1',
                           Mspk10LmpProduct_2_1: 'getPcddPcdd_Product_2',
                           Mspk10LmpProduct_2_2: 'getPcddPcdd_Product_3',
                           // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getPcddPcddProduct_1')
            this.$store.dispatch('getPcddPcddProduct_2')
            this.$store.dispatch('getPcddPcddProduct_3')
