    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                ...
                <!--</div>-->
                <div class="fl"><span id="page_game_name">重庆时时彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
                        id="page_name">第五球</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
            ...
            <div>
                ...
                <MssscSolProduct5 :info="{ productTitle: Mspk10LmpName, productContent: Mspk10LmpInput, product_1: MssscZhProduct_1, product_2_1: MssscZhProduct_2, product_2_2: MssscZhProduct_3}"></MssscSolProduct5>
...
<script>
    // 引入商品　投注页面
    import MssscSolProduct5 from './product_item/MssscSolProduct5'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           MssscZhProduct_1: 'getCqsscZh_Product_1',
                           MssscZhProduct_2: 'getCqsscZh_Product_2',
                           MssscZhProduct_3: 'getCqsscZh_Product_3',
                           // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getCqsscZhProduct_1')
            this.$store.dispatch('getCqsscZhProduct_2')
            this.$store.dispatch('getCqsscZhProduct_3')
            ...
            getData () {
                ...
                window.axios.get("/api/getCqssc").then(function (response) {
                    ...
                    var djs = parseInt(
                        ...
                        600 - (_data.servertime - _data.opentimestamp)
                    )
                    // 将数据存入vuex
