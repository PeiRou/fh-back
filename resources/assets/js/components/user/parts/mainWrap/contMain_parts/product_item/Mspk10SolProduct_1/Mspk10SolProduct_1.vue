<template>
    <td>
        <table class="u-table2">
                ...
                <Mspk10SolProduct_1_title v-for="item in info.productInfo.productTitle"
                                          v-if="item.id === info.productId.playCateId"
                                          :info="item"
                                          :key="item.id"></Mspk10SolProduct_1_title>
            ...
            <Mspk10SolProduct_1_content v-for="(item, index) in info.productId" :info="{ productId: item, productInfo: info.productInfo }" :key="index"></Mspk10SolProduct_1_content>
...
<script>
    import Mspk10SolProduct_1_title from './Mspk10SolProduct_1_parts/Mspk10SolProduct_1_title.vue'
    import Mspk10SolProduct_1_content from './Mspk10SolProduct_1_parts/Mspk10SolProduct_1_content.vue'


    export default {
        name: "mspk10-sol-product_1",
        props: {
            info: Object
        },
        components: {
            Mspk10SolProduct_1_title,
            Mspk10SolProduct_1_content
        }
    }
</script>
