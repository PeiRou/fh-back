        ...
        <div>
            <div class="cont-col3-bd">
                ...
                <table class="cont-list1">
                    ...
                    <tr>
                        <!--{{info.product_2_2}}-->
                        <MssscCombProduct_3 v-for="(item,index) in info.product_2_1" :info="{ productId: item, productInfo: info}" :key="index"></MssscCombProduct_3>
                        <!--<td>-->
...
<script>
    //　引入第一种商品
    import Mspk10LmpProduct_1 from './Xykl8ZhbswxProduct_1/Mspk10LmpProduct_1'
    //　引入第二种商品
    import Mspk10LmpProduct_2 from './Mspk10LmpProduct_2/Mspk10LmpProduct_2'

    import MssscCombProduct_3 from './Xykl8ZhbswxProduct_2/Mspk10LmpProduct_1'
    export default {
