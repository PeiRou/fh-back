<template>
  <tr style="float:left; width: 165.6px">
        ...
        <td :data-id="info.id" class="name" style="width: 10px;" @mouseover="addHover" @mouseleave="removeHover" :class="{'bg_yellow': mspk10LmpSealIsTrue ? false : changeClass === true, 'hover': hoverActive}" @click="!mspk10LmpSealIsTrue && addToCart(info.id)">{{info.name}}</td>
