        ...
        <div>
            <div class="cont-col3-bd">
                ...
                <table class="cont-list1">
                    ...
                    <tr>
                        <!--{{info.product_2_2}}-->
                        <Mspk10LmpProduct_2_2 v-for="(item,index) in info.product_2_1" :info="{ productId: item, productInfo: info}" :key="index"></Mspk10LmpProduct_2_2>
                        <!--<td>-->
                        <!--<table class="u-table2">-->
                        <!--<thead>-->
                        <!--<tr>-->
...
<script>
    ...
    // import Mspk10LmpProduct_1 from './XyddXyddProduct_2/Mspk10LmpProduct_1'
    import Mspk10LmpProduct_1 from './GdklsfLmpProduct_1/Mspk10LmpProduct_1'
    //　引入第二种商品的第一部分
    // import Mspk10LmpProduct_2 from './Mspk10LmpProduct_2/Mspk10LmpProduct_2'
    import Mspk10LmpProduct_2 from './GdklsfLmpProduct_2/Mspk10LmpProduct_2'

    // 引入第二种商品的第二部分
    import Mspk10LmpProduct_2_2 from './GdklsfLmpProduct_2/Mspk10LmpProduct_2_2'
