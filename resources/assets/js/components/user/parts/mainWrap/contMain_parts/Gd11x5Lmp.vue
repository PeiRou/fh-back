        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                <div class="fl"><span id="page_game_name">广东11选5</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
                        id="page_name">两面</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
...
<script>
    // 引入商品　投注页面
    import Mspk10LmpProduct from './product_item/Gd11x5LmpProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           Mspk10LmpProduct_1: 'getGd11x5Lm_Product_1',
                           Mspk10LmpProduct_2_1: 'getGd11x5Lm_Product_2',
                           Mspk10LmpProduct_2_2: 'getGd11x5Lm_Product_3',
                           // myState: 'getMyState',
