    ...
    <div class="cont-main">
        ...
        <div class="cont-col3">
            <div class="u-header play_tab_1 clearfix">
                ...
                <!--</div>-->
                <div class="fl"><span id="page_game_name">广东11选5</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span
...
<script>
    // 引入商品　投注页面
    import MssscCombProduct from './product_item/Gd11x5SolProduct'
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                           ...
                           MssscZhProduct_1: 'getGd11x5Lm_Product_1',
                           MssscZhProduct_2: 'getGd11x5Lm_Product_2',
                           MssscZhProduct_3: 'getGd11x5Lm_Product_3',
                           // myState: 'getMyState',
        ...
        created() {
            ...
            this.$store.dispatch('getGd11x5LmProduct_1')
            this.$store.dispatch('getGd11x5LmProduct_2')
            this.$store.dispatch('getGd11x5LmProduct_3')
