<template>
    ...
    <!--</tr>-->
    <!--<tr>{{info}}</tr>-->
    <!--<tr v-for='(item,index) in info.productInfo.productContent' v-if="item.id === info.productId && isNaN(parseInt(item.code))">-->
    <!--由于数字要放前面-->

    <!--文字-->
    <Mspk10LmpProduct_2_content_item v-for="(item,index) in info.productInfo.productContent" v-if="item.playCateId === info.productId && isNaN(parseInt(item.code))" :info="item" :key="index"></Mspk10LmpProduct_2_content_item>


    <!--0号-->
    <!--特别要注意这里的0是字符串-->
    <Mspk10LmpProduct_2_content_item_2 v-for="(item,index) in info.productInfo.productContent" v-if="item.playCateId === info.productId && item.code === '0'" :info="item" :key="index"></Mspk10LmpProduct_2_content_item_2>


    <!--1-9号-->
    <Mspk10LmpProduct_2_content_item_2 v-for="(item,index) in info.productInfo.productContent" v-if="item.playCateId === info.productId && parseInt(item.code)" :info="item" :key="index"></Mspk10LmpProduct_2_content_item_2>
...
<script>
    import Mspk10LmpProduct_2_content_item from './item/Mspk10LmpProduct_2_content_item.vue'
    import Mspk10LmpProduct_2_content_item_2 from './item/Mspk10LmpProduct_2_content_item_2.vue'
    ...
    export default {
        ...
        components: {
            Mspk10LmpProduct_2_content_item,
            Mspk10LmpProduct_2_content_item_2
        },
        data () {
            return {
                changeClass: false
