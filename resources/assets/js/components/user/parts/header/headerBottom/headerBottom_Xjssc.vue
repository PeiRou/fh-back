<template>
        <div class="header-bottom sub">
            <div class="show cate_menu">
                <router-link to="/xjssc/comb" exact :class="{ selected: changeSelect === 0 }" @click.native="changeSelected(0)">整合</router-link> |
                <router-link to="/xjssc/sol1" exact :class="{ selected: changeSelect === 1 }" @click.native="changeSelected(1)">第一球</router-link> |
                <router-link to="/xjssc/sol2" exact :class="{ selected: changeSelect === 2 }" @click.native="changeSelected(2)">第二球</router-link> |
                <router-link to="/xjssc/sol3" exact :class="{ selected: changeSelect === 3 }" @click.native="changeSelected(3)">第三球</router-link> |
                <router-link to="/xjssc/sol4" exact :class="{ selected: changeSelect === 4 }" @click.native="changeSelected(4)">第四球</router-link> |
                <router-link to="/xjssc/sol5" exact :class="{ selected: changeSelect === 5 }" @click.native="changeSelected(5)">第五球</router-link>
            </div>
        </div>
</template>
