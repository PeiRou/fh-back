<template>
        <div class="header-bottom sub">
            <div class="show cate_menu">
                <router-link to="/pk10/lmp" exact :class="{ selected: changeSelect === 0 }" @click.native="changeSelected(0)">两面盘</router-link> |
                <router-link to="/pk10/sol" exact :class="{ selected: changeSelect === 1 }" @click.native="changeSelected(1)">单号1~10</router-link> |
                <router-link to="/pk10/com" exact :class="{ selected: changeSelect === 2 }" @click.native="changeSelected(2)">冠亚组合</router-link>
            </div>
        </div>
</template>
