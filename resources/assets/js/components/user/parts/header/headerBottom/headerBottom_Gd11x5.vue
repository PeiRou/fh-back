<template>
        <div class="header-bottom sub">
            <div class="show cate_menu">
                <router-link to="/gd11x5/lmp" exact :class="{ selected: changeSelect === 0 }" @click.native="changeSelected(0)">两面</router-link> |
                <router-link to="/gd11x5/sol" exact :class="{ selected: changeSelect === 1 }" @click.native="changeSelected(1)">单号</router-link> |
                <router-link to="/gd11x5/lm" exact :class="{ selected: changeSelect === 2 }" @click.native="changeSelected(2)">连码</router-link> |
                <router-link to="/gd11x5/zx" exact :class="{ selected: changeSelect === 3 }" @click.native="changeSelected(3)">直选</router-link>
            </div>
        </div>
</template>
