<template>
        <div class="header-bottom sub">
            <div class="show cate_menu">
                <router-link to="/xykl8/lmp" exact :class="{ selected: changeSelect === 0 }" @click.native="changeSelected(0)">两面盘</router-link> |
                <router-link to="/xykl8/zhbswx" exact :class="{ selected: changeSelect === 1 }" @click.native="changeSelected(1)">总和、比数、五行</router-link> |
                <router-link to="/xykl8/zm" exact :class="{ selected: changeSelect === 2 }" @click.native="changeSelected(2)">正码</router-link>
            </div>
        </div>
</template>
