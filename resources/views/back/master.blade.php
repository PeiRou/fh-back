...
<div class="nav-top">
    ...
    <div class="nav-user-info">
        <ul style="margin-top: 20px;">
            ...
            <li onclick="javascript:(location.href='/back/control/userManage/onlineUser')"><i data-tooltip="在线移动端人数" data-position="bottom center" data-inverted class='Hui-iconfont'>&#xe696;</i>：<span id="onlineUserCountM">0</span></li>
            ...
            <li onclick="javascript:(location.href='/back/control/systemManage/feedback')" id="feedbackContent"><i data-tooltip="在线子帐号人数" data-position="bottom center" data-inverted class='Hui-iconfont'>&#xe70c;</i>：<span id="feedbackCount">0</span></li>
            {{--<li>修改密码</li>--}}
