...
@section('content')
    ...
    <div class="table-content">
        <table align="center" class="ui small selectable celled striped table">
            ...
            {{--</tr>--}}
            <tr>
                <td valign="top" style="word-break: break-all;vertical-align: middle;">一天一个IP能注册多少用户（0表示不限制）</td>
                <td valign="top" style="word-break: break-all;text-align: center;">
                    <div class="ui input">
            ...
            <tr>
                <td valign="top" style="word-break: break-all;vertical-align: middle;">提现检查打码量(参数是充值金额的倍数)</td>
                <td valign="top" style="word-break: break-all;text-align: center;">
