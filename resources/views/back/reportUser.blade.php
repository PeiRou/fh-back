    ...
    <div class="table-content">
        ...
        <table id="reportUserTable" class="ui small selectable celled striped table" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <th>姓名</th>
                <th>上级代理</th>
                <th><span class="tips-icon"><i data-tooltip="会员的充值金额（今天没有下注，只有充值不会显示）" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 充值金额</th>
                <th><span class="tips-icon"><i data-tooltip="会员的提款金额（今天没有下注，只有提款不会显示）" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 取款金额</th>
                <th><span class="tips-icon"><i data-tooltip="会员投注笔数" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 笔数</th>
                <th><span class="tips-icon"><i data-tooltip="会员投注金额" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 投注金额</th>
                <th><span class="tips-icon"><i data-tooltip="会员盈利的投注金额" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 赢利投注金额</th>
                <th><span class="tips-icon"><i data-tooltip="会员的活动金额（今天没有下注，只有活动金额不会显示）" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 活动金额</th>
                <th><span class="tips-icon"><i data-tooltip="会员的充值优惠/手续费（今天没有下注，只有充值优惠/手续费不会显示）" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 充值优惠/手续费</th>
                <th><span class="tips-icon"><i data-tooltip="会员输赢（小于零为平台赢，大于零位会员赢）" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 会员输赢(不含退水)</th>
                <th><span class="tips-icon"><i data-tooltip="会员实际退水(单笔投注金额 * 退水比例)" data-position="top center" data-inverted class="iconfont">&#xe61e;</i></span> 实际退水</th>
