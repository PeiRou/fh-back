        ...
        <div class="table-quick-bar">
            <div class="ui mini form">
                <div class="fields">
                    ...
                    <div class="one wide field">
                        <input type="text" id="minMoney" oninput = " value=value.replace(/[^\d|\.]/g,'')" placeholder="最小金额">
                    </div>
                    <div class="one wide field">
                        <input type="text" id="maxMoney" oninput = " value=value.replace(/[^\d|\.]/g,'')" placeholder="最大金额">
                    </div>
                    <div class="one wide field">
