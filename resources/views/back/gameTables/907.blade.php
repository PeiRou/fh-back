<!-- 匈牙利时时彩 -->
<form id="game907Form" action="{{ url('/game/table/save/xylssc') }}">
    <table align="center" class="ui celled small table">
        <tbody>
        <tr class="firstRow">
            <td valign="middle" rowspan="1" colspan="4" align="center" class="blue-title-table">匈牙利时时彩</td>
        </tr>
        <tr class="firstRow">
        ...
        <tr>
            ...
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_baozi_odds" value="{{ $odds['q3z3h3_baozi_odds'] }}">
                </div>
            </td>
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_baozi_rebate" value="{{ $rebate['q3z3h3_baozi_rebate'] }}">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_shunzi_odds" value="{{ $odds['q3z3h3_shunzi_odds'] }}">
                </div>
            </td>
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_shunzi_rebate" value="{{ $rebate['q3z3h3_shunzi_rebate'] }}">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_duizi_odds" value="{{ $odds['q3z3h3_duizi_odds'] }}">
                </div>
            </td>
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_duizi_rebate" value="{{ $rebate['q3z3h3_duizi_rebate'] }}">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_banshun_odds" value="{{ $odds['q3z3h3_banshun_odds'] }}">
                </div>
            </td>
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_banshun_rebate" value="{{ $rebate['q3z3h3_banshun_rebate'] }}">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_zaliu_odds" value="{{ $odds['q3z3h3_zaliu_odds'] }}">
                </div>
            </td>
            <td valign="middle" colspan="1" rowspan="1" align="center">
                <div class="ui input">
                    <input type="text" name="q3z3h3_zaliu_rebate" value="{{ $rebate['q3z3h3_zaliu_rebate'] }}">
                </div>
            </td>
        </tr>
        </tbody>
