<!-- QQ分分彩 -->
<form id="game113Form" action="{{ url('/game/table/save/qqffc') }}">
    <table align="center" class="ui celled small table">
        <tbody>
        <tr class="firstRow">
            <td valign="middle" rowspan="1" colspan="4" align="center" class="blue-title-table">QQ分分彩</td>
        </tr>
        <tr>
