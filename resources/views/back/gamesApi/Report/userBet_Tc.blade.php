...
<div class="user-bet-list">
    <div class="content-top">
        <div class="breadcrumb">
            <b>位置：</b>统计报表
            <button style="line-height: 20px;border:0;margin-left: 10px;cursor:pointer;" onclick="parent.layer.close(parent.parent.openIndex1)">返回</button>
        </div>
    </div>
            ...
            <div class="ui mini form">
                <div class="fields">
                    ...
                    <div class="one wide field"  style="width: 130px !important;">
                        <input type="text" id="username"  placeholder="会员" value="{{ request()->username ?? '' }}">
                    </div>
...
<script>
    ...
    var dataTable;
    // alert(parent.dataTag)
    {{--alert({{ request()->productType }});--}}
    $(function () {
        var columns = [
        ...
        function createTable(columns) {
            return $('#tableData').DataTable({
                ...
                aLengthMenu: [[20]],
                ajax: {
                    url:'/back/datatables/reportGamesApiBet_Tc',
                    type:'get',
                    data:function (d) {
    ...
    function info(productType, username, gameCategory){
        window.open('/back/control/cardGameManage/TCBetInfo?productType='+productType+'&username='+username+'&gameCategory='+gameCategory);
        // top.location.href = '/back/control/cardGameManage/TCBetInfo?productType='+productType+'&username='+username+'&gameCategory='+gameCategory;
    }
