        ...
        <div class="field">
            ...
            <div class="ui calendar">
                <div class="ui input left icon">
                    ...
                    <input type="text" id="rangeStart" name="holiday_start" value="{{ date('Y-m-d',strtotime($game->holiday_start)) }}">
                </div>
            </div>
        </div>
        <div class="field">
            ...
            <div class="ui calendar">
                <div class="ui input left icon">
                    <i class="calendar icon"></i>
                    <input type="text" id="rangeEnd" name="holiday_end" value="{{ date('Y-m-d',strtotime($game->holiday_end)) }}">
                </div>
            </div>
        </div>
    </div>
