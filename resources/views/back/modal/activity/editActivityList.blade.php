...
<form id="editArticleForm" class="ui form" action="{{ url('/action/admin/activity/editActivity') }}">
    <div class="field">
        ...
        <div class="ui input icon">
            <input type="text" name="name" value="{{ $activityInfo->name }}"/>
        </div>
    </div>
    <div class="field">
        <label>活动时间</label>
        <div class="ui calendar in-block" id="rangestart" style="width: 108px;">
            <div class="ui input left icon">
                ...
                <input type="text" name="start_time" id="start_time" value="{{ $activityInfo->start_time }}" placeholder="">
            </div>
        </div>
        <span> - </span>
        <div class="ui calendar in-block" id="rangeend" style="width: 108px;">
            <div class="ui input left icon">
                <i class="calendar icon"></i>
                <input type="text" name="end_time" id="end_time" value="{{ $activityInfo->end_time }}" placeholder="">
            </div>
        </div>
    </div>
    <div class="field">
    ...
    <div class="field">
        <label>活动说明</label>
        <div class="ui input icon">
            <textarea name="content" class="txta">{{ $activityInfo->content }}</textarea>
        </div>
    </div>
