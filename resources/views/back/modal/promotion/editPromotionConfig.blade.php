...
<form id="editArticleForm" class="ui form" action="{{ url('/action/admin/promotion/editConfig') }}">
    <div class="field">
        <label>层级 : </label>
        <div class="ui input icon">
            <input type="text" name="level" value="{{ $iPromotionInfo->level }}"/>
        </div>
    </div>
    <div class="field">
        <label>达标投注额</label>
        <div class="ui input icon">
            <input type="text" name="money" value="{{ $iPromotionInfo->money }}"/>
        </div>
    </div>
    <div class="field">
        <label>提成比例(%)</label>
