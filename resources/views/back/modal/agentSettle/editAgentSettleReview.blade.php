...
<form id="editArticleForm" class="ui form" action="{{ url('/action/admin/agentSettle/editReview') }}">
    <div class="field">
        <label>代理账号</label>
    ...
    <div class="field">
        <label>实际输赢</label>
        <div class="ui input icon">
            <input type="text" value="{{ $settleInfo->real_bunko }}" readonly="readonly"/>
        </div>
    </div>
    <div class="field">
        <label>平台费用比</label>
    ...
    <div class="field">
        <label>纯赢利</label>
        <div class="ui input icon">
            <input type="text" value="{{ $settleInfo->fee_bunko }}" readonly="readonly"/>
        </div>
    </div>
    <div class="field">
        <label>累计纯赢利</label>
    ...
    <div class="field">
        <label>代理佣金</label>
        <div class="ui input icon">
            <input type="text" value="{{ $settleInfo->commission }}" readonly="readonly"/>
        </div>
    </div>
    <div class="field">
        <label>累计佣金</label>
