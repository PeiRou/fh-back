...
<form id="editPayCftForm" class="ui mini form" action="{{ url('/action/admin/new/editPayCft') }}">
    ...
    <div class="field">
        <label>二维码图片</label>
        <div class="ui input icon">
            <input type="hidden" name="qrCode"  placeholder="" value="{{ $payCft->qrCode }}"/>
            <textarea style="display: none" id="qrCodeBase64" name="qrCodeBase64"  >{{ $payCft->qrCodeBase64 }}</textarea>
